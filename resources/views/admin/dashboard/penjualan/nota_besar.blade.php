    ...
    <table width="100%">
        <tr>
            <td rowspan="4" width="60%">
                <img src="{{ public_path($settings->logo_toko) }}" alt="{{ $settings->logo_toko }}" width="120">
                <br>
                {{ $settings->alamat }}
                <br>
                <br>
    ...
    <table class="data" width="100%">
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right"><b>{{ format_uang($penjualans->total_harga) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Diskon</b></td>
                <td class="text-right"><b>{{ format_uang($penjualans->diskon) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Total Bayar</b></td>
                <td class="text-right"><b>{{ format_uang($penjualans->bayar) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Diterima</b></td>
                <td class="text-right"><b>{{ format_uang($penjualans->diterima) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Kembali</b></td>
                <td class="text-right"><b>{{ format_uang($penjualans->diterima - $penjualans->bayar) }}</b></td>
            </tr>
        </tfoot>
    </table>
