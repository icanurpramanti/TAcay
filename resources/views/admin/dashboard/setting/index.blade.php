...
<div class="row">
    <div class="col-lg-12">
        <div class="box">
            <form action="{{ route('admin.dashboard.setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
...
<script>
    ...
    function showData() {
        $.get('{{ route("admin.dashboard.setting.show") }}')
            .done(response => {
