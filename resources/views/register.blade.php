    ...
    <div class="container"><br>
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                        <label><i class="fa fa-user"></i> Alamat User</label>
                        <input type="text" name="alamat_user" class="form-control" placeholder="alamat" required="">
                    </div>
                    <div class="form-group">
                        <label><i class="fa fa-user"></i> NoHp</label>
                        <input type="text" name="no_hp" class="form-control" placeholder="nohp" required="">
                    </div>
