...
class PenjualanDetailKasirController extends Controller
{
    public function index()
    {
        ...
        return view('kasir.dashboard.penjualan_detail.index', compact('id_penjualan', 'produks', 'diskon'));
    }
    ...
    public function data($id)
    {
        ...
        foreach ($detail as $item) {
            ...
            $row['aksi']        = '<div class="btn-group">
                                     <button onclick="deleteData(`' . route('transaksikasir.destroy', $item->id_penjualan_detail) . '`)" class="btn btn-xs btn-danger btn-flat"><i class="fa fa-trash"></i></button>
                                 </div>';
            $data[] = $row;
